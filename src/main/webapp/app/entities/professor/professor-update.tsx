  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="toothApp.professor.home.createOrEditLabel" data-cy="ProfessorCreateUpdateHeading">
            <Translate contentKey="toothApp.professor.home.createOrEditLabel">Create or edit a Professor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('toothApp.professor.grade')} id="professor-grade" name="grade" data-cy="grade" type="text" />
              <ValidatedField
                id="professor-user"
                name="user"
                data-cy="user"
                label={translate('toothApp.professor.user')}
                type="select"
                required
              >
                <option value="" key="0" />
