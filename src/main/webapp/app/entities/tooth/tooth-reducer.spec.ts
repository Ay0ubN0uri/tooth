...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tooth.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOOTH_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOOTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOOTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOOTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOOTH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOOTH actions', async () => {
      const expectedActions = [
        {
