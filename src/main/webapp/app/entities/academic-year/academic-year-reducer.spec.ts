...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMICYEAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACADEMICYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACADEMICYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACADEMICYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMICYEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACADEMICYEAR actions', async () => {
      const expectedActions = [
        {
