...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pw.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PW_LIST actions', async () => {
    ...
    it('dispatches FETCH_PW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PW actions', async () => {
      const expectedActions = [
        {
