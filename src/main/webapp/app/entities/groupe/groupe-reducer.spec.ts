...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './groupe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPE actions', async () => {
      const expectedActions = [
        {
