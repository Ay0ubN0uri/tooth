...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTPW_LIST actions', async () => {
    ...
    it('dispatches FETCH_STUDENTPW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STUDENTPW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STUDENTPW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTPW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STUDENTPW actions', async () => {
      const expectedActions = [
        {
